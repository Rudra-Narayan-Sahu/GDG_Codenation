            ...
            <div className="max-w-4xl mx-auto hud-glass p-8 rounded-xl relative border-[3px] border-[#07fc03]/20 glowing-box">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="mt-12 pt-6 flex justify-end gap-4">
                        <button type="button" onClick={() => navigate(`/contests/${id}`)} className="bg-gray-800 hover:bg-gray-700 text-white font-bold uppercase tracking-widest px-8 py-3 rounded disabled:opacity-50">
                            Cancel
                        </button>
